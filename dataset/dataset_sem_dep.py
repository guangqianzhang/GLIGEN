...
class Sem_depDataset():
    def __init__(self, image_rootdir, depth_rootdir,sem_rootdir, caption_path, prob_use_caption=1, image_size=512, random_flip=False):
        ...
        assert len(self.image_files) ==len(self.dep_file)== len(self.sem_files) == len(self.image_filename_to_caption_mapping)
    ...
    def __getitem__(self, index):
        ...
        depth = TF.center_crop(dep, crop_size)
